...
export function Sidebar({ className, onClose }: SidebarProps) {
  ...
  const menuItems = [
    ...
    {
      section: "FERRAMENTAS DO MENTOR",
      items: [
        { icon: LayoutDashboard, label: "Dashboard", href: "/dashboard" },
        { icon: Plus, label: "Criar Mentoria", href: "/mentoria/criar" },
        { icon: Brain, label: "IA para Mentorias", href: "/ia-mentorias" },
        { icon: BookOpen, label: "Minhas Mentorias", href: "/minhas-mentorias" },
        { icon: PlusCircle, label: "Criar Quiz", href: "/quiz/criar" },
        { icon: FileQuestion, label: "Meus Quizzes", href: "/meus-quizzes" },
        { icon: Users, label: "Meus Alunos", href: "/meus-alunos" },
      ]
    }
  ];
